 ...
 * "Braking Bank" is a very simple, text based adventure game.  
 *
 * This class holds information about a command that was issued by the user.
 * A command currently consists of two parts: a CommandWord and a string (for example, if the command was "take gun", then the two parts are TAKE and "gun").
 * 
...
public class Command
{
     ...
     * First and second words must be supplied, but the second may be null.
     * 
     * @param commandWord The CommandWord. 
     * UNKNOWN if the command word was not recognised.
     * 
